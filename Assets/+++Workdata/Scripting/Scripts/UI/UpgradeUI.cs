...
public class UpgradeUI : MonoBehaviour
{
    ...
    private void UpgradeWeapon(string weapon, WeaponObjectSO[] upgradeTiers)
    {
        for (int _i = 0; _i < PlayerBehaviour.Instance.weaponBehaviour.allWeaponPrizes.Count; _i++)
        {
            ...
            {
                PlayerBehaviour.Instance.weaponBehaviour.allWeaponPrizes[_i] = PlayerBehaviour.Instance.weaponBehaviour.allWeaponPrizes[_i].upgradeTier switch
                {
                    0 => upgradeTiers[0],
                    1 => upgradeTiers[1],
                    2 => upgradeTiers[2],
                    _ => PlayerBehaviour.Instance.weaponBehaviour.allWeaponPrizes[_i]
                };
